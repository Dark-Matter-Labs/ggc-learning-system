  ...
  return (
    <div>
      ...
      <button
        ...
        disabled={generating}
        className="mb-6 flex items-center gap-2 px-4 py-2 text-sm bg-node-hunch text-white rounded-md hover:opacity-90 disabled:opacity-50 disabled:cursor-not-allowed transition-opacity"
      >
